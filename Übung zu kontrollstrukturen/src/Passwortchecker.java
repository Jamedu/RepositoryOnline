	...
	//	System.out.println();
			...
			*/
			...
			System.out.println(" ");
			 ...
			 if(langGenug==true && eineZahl==true && einGroﬂ==true && einKlein==true && einSonder==true)
			 {
			 ...
			 if(einGroﬂ==false)
			 {
				 System.out.println("Deinem Passwort fehlt mindestens ein Groﬂbuchstabe!");
			 }else {
